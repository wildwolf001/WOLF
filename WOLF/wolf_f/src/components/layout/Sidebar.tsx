...
// DEPRECATED: navItems simplified - 'team' removed (multi-agent collaboration disabled)
const navItems = [
  ...
  // DEPRECATED: 'team' removed - multi-agent collaboration disabled
...
export function Sidebar() {
  const { currentView, setCurrentView, currentProject, projects } = useUIStore();

  return (
    <div
      className={clsx(
        'flex flex-col bg-vscode-bg-light border-r border-vscode-border transition-all duration-300'
      )}
      style={{ width: '240px' }}
    >
        ...
        <div className="p-3 border-t border-vscode-border">
          ...
          <div className="flex items-center gap-2">
            ...
            {currentProject.projectModeEnabled && (
              <span className="px-1 py-0.5 text-xs bg-vscode-accent/20 text-vscode-accent rounded">
                Mode
              </span>
            )}
          </div>
      ...
      <div className="p-3 border-t border-vscode-border">
        <div className="text-xs text-vscode-text-dim">
          WOLF v2.0.0 {/* DEPRECATED: multi-agent removed, single-agent mode */}
        </div>
      </div>
    </div>
  );
